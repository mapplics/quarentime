...
export class LoginPage extends PageInterface implements OnInit {
    ...
    onLoginGoogle() {
        if (this.platform.is('mobileweb')) {
            this.goToOnboarding();
            // simulo los datos
            localStorage.setItem('quarentimeToken', "eyJhbGciOiJSUzI1NiIsImtpZCI6IjgzYTczOGUyMWI5MWNlMjRmNDM0ODBmZTZmZWU0MjU4Yzg0ZGI0YzUiLCJ0eXAiOiJKV1QifQ..ScNh0kfUpWKKHPGC71LrxrYFsDbKJW5q9X5xUTjxGb_DDy3nQEmZImv6RR4N8qtcP0Lu8SnJCP4eF0nETiCkuqN9Uy6LEPFbjiq5AfOP4OlXDR3iIYhqhqyXe8JzZha8eV4GHDjoDDg5PfzfqB5m8QVBZKOWPfGYXA1uPoiyz02KQ3w-NvkNhJoX5qNhqAmmYJjT5xOjp_7A26yn6ADmThzpLeIwLjax9iVM10zrTkDWYwxOy2a4wnlrKv4e8k0EAafBcfq06J5voAW7Ur4k45F-SY4NAqATRU_Q-b7iYVQhh9tdcGqdi7fAB13tOAwwjrFFm3wUxeqa3PEYp1pLGg");
