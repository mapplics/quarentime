...
export class LoginPage extends PageInterface implements OnInit {
    ...
    onLoginGoogle() {
        if (this.platform.is('mobileweb')) {
            this.goToOnboarding();
            // simulo los datos
            localStorage.setItem('quarentimeToken', "eyJhbGciOiJSUzI1NiIsImtpZCI6IjgzYTczOGUyMWI5MWNlMjRmNDM0ODBmZTZmZWU0MjU4Yzg0ZGI0YzUiLCJ0eXAiOiJKV1QifQ..J9RG7EuVpdo4c8NvTIUSiIaDx7UJBChPKcLYlc0BQdSMdIVoJHz8eX4B5NQWxlvj7PXpssYkgMG9H4pvknQzHoAjG6_endBSV5vmTJDnauqHHtAldZjY5yvfAIOaoO3LNRFhKHKQMDgvGmSN776ZLhRSNDW-xHcSIwh0NSSKSTNZ4mR-2G3IoUM_lcq53eTHjjcYFim54Fc8JdZ8BBiIUxjYObR93Oc2uQKBvLBdQqrqNbf8_ac2fxsinatBXf6oVcwfphWkYkJrVcXtdK-l2yAAWPmy3RZ1H8omwgASPDfF4xpEXDIkoPkn2ie1YeFLxdNbxDXzFXSJOKxtiDBWdA");
